		...
		<table class="table" style="font-family: century gothic"
			...
			<thead>
				<tr>
					...
					<th style="font =weight: bold;">Nkw</th>
					<th style="font =weight: bold;">Nid</th>
					<th style="font =weight: bold;">Nop</th>
					<th style="font =weight: bold;">Nnv</th>
					<th style="font =weight: bold;">Nsl</th>
